...
\section{Parameter Adaption}\label{param_adaption}
    ...
    from the \emph{virial theorem}~\cite{landau1972theoretical}.
    From the virial theorem, we aim to match the average kinetic and potential energy as
    \begin{equation}\label{eq:virial_theorem}
        2 \langle T \rangle = \langle U \rangle.
    \end{equation}
    Following the derivation in~\ref{sec:metric_derivation} we arrive at the result
...
