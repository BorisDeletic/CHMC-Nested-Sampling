...
\section{Auto Differentiation}\label{sec:autodiff}
    ...
    One such example is \textsc{Enzyme AD}, a tool that takes arbitrary existing code base in a variety of languages
    (including C++) and computes the gradient of that function.
    We demonstrate this capability on a simple function which allows CHMC to automatically run without needing to
