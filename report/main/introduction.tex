...
\begin{document}
    ...
    A different approach to \emph{parameter estimation} is with Bayesian inference.
    ...
    Nested sampling offers several advantages to classic MCMC algorithms, including simultaneous calculation of
    \emph{model evidence}, as well as dealing effectively with multimodal distributions.
    ...
    \section{Hamiltonian Monte Carlo}\label{HMC}
